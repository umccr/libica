...
from libiap.openapi.libwes.api.workflow_runs_api import WorkflowRunsApi  # noqa: E501
...
class TestWorkflowRunsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = libiap.openapi.libwes.api.workflow_runs_api.WorkflowRunsApi()  # noqa: E501
