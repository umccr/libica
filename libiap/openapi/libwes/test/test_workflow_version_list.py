...
from libiap.openapi.libwes.models.workflow_version_list import WorkflowVersionList  # noqa: E501
...
class TestWorkflowVersionList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = libiap.openapi.libwes.models.workflow_version_list.WorkflowVersionList()  # noqa: E501
        if include_optional :
            return WorkflowVersionList(
                items = [
                    libiap.openapi.libwes.models.workflow_version_compact.WorkflowVersionCompact(
                        id = '0', 
                        urn = '0', 
                        href = '0', 
                        version = '0', 
