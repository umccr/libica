...
from libiap.openapi.libwes.api.workflow_versions_api import WorkflowVersionsApi  # noqa: E501
...
class TestWorkflowVersionsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = libiap.openapi.libwes.api.workflow_versions_api.WorkflowVersionsApi()  # noqa: E501
