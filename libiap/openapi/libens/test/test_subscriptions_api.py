...
from libiap.openapi.libens.api.subscriptions_api import SubscriptionsApi  # noqa: E501
...
class TestSubscriptionsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = libiap.openapi.libens.api.subscriptions_api.SubscriptionsApi()  # noqa: E501
