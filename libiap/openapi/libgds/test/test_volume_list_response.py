...
from libiap.openapi.libgds.models.volume_list_response import VolumeListResponse  # noqa: E501
...
class TestVolumeListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = libiap.openapi.libgds.models.volume_list_response.VolumeListResponse()  # noqa: E501
        if include_optional :
            return VolumeListResponse(
                items = [
                    libiap.openapi.libgds.models.volume_response.VolumeResponse(
                        id = '0', 
                        name = '0', 
                        tenant_id = '0', 
                        sub_tenant_id = '0', 
