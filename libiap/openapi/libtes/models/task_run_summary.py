...
class TaskRunSummary(object):
    ...
    def __init__(self, id=None, name=None, href=None, description=None, status='Pending', status_details=None, task_version_summary=None, acl=None, tenant_id=None, sub_tenant_id=None, created_by=None, time_created=None, modified_by=None, time_modified=None, local_vars_configuration=None):  # noqa: E501
