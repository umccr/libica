...
- Build date: 2023-10-10T19:58:27.682103+11:00[Australia/Melbourne]
...
*ProjectPipelineApi* | [**create_pipeline_file**](docs/ProjectPipelineApi.md#create_pipeline_file) | **POST** /api/projects/{projectId}/pipelines/{pipelineId}/files | Create a file for a pipeline.
*ProjectPipelineApi* | [**delete_pipeline_file**](docs/ProjectPipelineApi.md#delete_pipeline_file) | **DELETE** /api/projects/{projectId}/pipelines/{pipelineId}/files/{fileId} | Delete a file for a pipeline.
*ProjectPipelineApi* | [**download_pipeline_file_content1**](docs/ProjectPipelineApi.md#download_pipeline_file_content1) | **GET** /api/projects/{projectId}/pipelines/{pipelineId}/files/{fileId}/content | Download the contents of a pipeline file.
*ProjectPipelineApi* | [**get_pipeline_files1**](docs/ProjectPipelineApi.md#get_pipeline_files1) | **GET** /api/projects/{projectId}/pipelines/{pipelineId}/files | Retrieve files for a project pipeline.
...
*ProjectPipelineApi* | [**update_pipeline_file**](docs/ProjectPipelineApi.md#update_pipeline_file) | **PUT** /api/projects/{projectId}/pipelines/{pipelineId}/files/{fileId}/content | Update the contents of a file for a pipeline.
