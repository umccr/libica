...
------------ | ------------- | ------------- | -------------
**id** | **str** |  | 
**values** | **[str, none_type], none_type** | Use &#39;values&#39; for all fields except data fields. Use string values to avoid rounding of numbers with a high precision. Values of length 0 for textbox type fields will be treated as null. | [optional] 
