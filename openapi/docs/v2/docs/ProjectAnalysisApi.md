...
[**h_get_execution_output_object**](ProjectAnalysisApi.md#h_get_execution_output_object) | **GET** /api/projects/{projectId}/analyses/{analysisId}/rawOutput | Retrieve the raw output of an analysis.
...
------------- | ------------- | ------------- | -------------
 **project_id** | **str**|  |
 **create_cwl_analysis** | [**CreateCwlAnalysis**](CreateCwlAnalysis.md)|  |
...
------------- | ------------- | ------------- | -------------
 **project_id** | **str**|  |
 **create_nextflow_analysis** | [**CreateNextflowAnalysis**](CreateNextflowAnalysis.md)|  |
...
# **h_get_execution_output_object**
> AnalysisRawOutput h_get_execution_output_object(project_id, analysis_id)
...
with libica.openapi.v2.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve the raw output of an analysis.
        api_response = api_instance.h_get_execution_output_object(project_id, analysis_id)
        pprint(api_response)
    except libica.openapi.v2.ApiException as e:
        print("Exception when calling ProjectAnalysisApi->h_get_execution_output_object: %s\n" % e)
```
