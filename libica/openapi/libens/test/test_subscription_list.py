...
from libica.openapi.libens.models.subscription_list import SubscriptionList  # noqa: E501
...
class TestSubscriptionList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = libica.openapi.libens.models.subscription_list.SubscriptionList()  # noqa: E501
        if include_optional :
            return SubscriptionList(
                items = [
                    libica.openapi.libens.models.subscription.Subscription(
                        id = '0', 
                        urn = '0', 
                        type = '0', 
                        actions = [
