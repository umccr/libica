...
class FileListCopyRequest(object):
    ...
    def __init__(self, source_volume_id=None, destination_folder_id=None, ids=None, metadata_to_copy=None, duplicate_file_action=None, local_vars_configuration=None):  # noqa: E501
