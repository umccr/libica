...
class FileListCopyRequest(object):
    ...
    def __init__(self, source_volume_id=None, destination_folder_id=None, ids=None, metadata_to_copy=None, metadata_to_update=None, metadata_items_to_add=None, metadata_items_to_delete=None, duplicate_file_action=None, local_vars_configuration=None):  # noqa: E501
        """FileListCopyRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def source_volume_id(self):
        """Gets the source_volume_id of this FileListCopyRequest.  # noqa: E501

        The volume where the source files are copied from.  # noqa: E501

        :return: The source_volume_id of this FileListCopyRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def source_volume_id(self, source_volume_id):
        """Sets the source_volume_id of this FileListCopyRequest.

        The volume where the source files are copied from.  # noqa: E501

        :param source_volume_id: The source_volume_id of this FileListCopyRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ids(self):
        """Gets the ids of this FileListCopyRequest.  # noqa: E501

        List of files ids to copy  # noqa: E501

        :return: The ids of this FileListCopyRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this FileListCopyRequest.

        List of files ids to copy  # noqa: E501

        :param ids: The ids of this FileListCopyRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def metadata_to_copy(self):
        """Gets the metadata_to_copy of this FileListCopyRequest.  # noqa: E501

        List of metadata to be copied/kept  # noqa: E501

        :return: The metadata_to_copy of this FileListCopyRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def metadata_to_copy(self, metadata_to_copy):
        """Sets the metadata_to_copy of this FileListCopyRequest.

        List of metadata to be copied/kept  # noqa: E501

        :param metadata_to_copy: The metadata_to_copy of this FileListCopyRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def metadata_to_update(self):
        """Gets the metadata_to_update of this FileListCopyRequest.  # noqa: E501

        Modifies the contents of existing metadata  # noqa: E501

        :return: The metadata_to_update of this FileListCopyRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def metadata_to_update(self, metadata_to_update):
        """Sets the metadata_to_update of this FileListCopyRequest.

        Modifies the contents of existing metadata  # noqa: E501

        :param metadata_to_update: The metadata_to_update of this FileListCopyRequest.  # noqa: E501
        :type: object
        """
    ...
    def metadata_items_to_add(self):
        """Gets the metadata_items_to_add of this FileListCopyRequest.  # noqa: E501

        Add an item to a metadata with array type  # noqa: E501

        :return: The metadata_items_to_add of this FileListCopyRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def metadata_items_to_add(self, metadata_items_to_add):
        """Sets the metadata_items_to_add of this FileListCopyRequest.

        Add an item to a metadata with array type  # noqa: E501

        :param metadata_items_to_add: The metadata_items_to_add of this FileListCopyRequest.  # noqa: E501
        :type: object
        """
    ...
    def metadata_items_to_delete(self):
        """Gets the metadata_items_to_delete of this FileListCopyRequest.  # noqa: E501

        Delete an item from a metadata with array type  # noqa: E501

        :return: The metadata_items_to_delete of this FileListCopyRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def metadata_items_to_delete(self, metadata_items_to_delete):
        """Sets the metadata_items_to_delete of this FileListCopyRequest.

        Delete an item from a metadata with array type  # noqa: E501

        :param metadata_items_to_delete: The metadata_items_to_delete of this FileListCopyRequest.  # noqa: E501
        :type: object
        """
    ...
    def duplicate_file_action(self):
        """Gets the duplicate_file_action of this FileListCopyRequest.  # noqa: E501


        :return: The duplicate_file_action of this FileListCopyRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def duplicate_file_action(self, duplicate_file_action):
        """Sets the duplicate_file_action of this FileListCopyRequest.


        :param duplicate_file_action: The duplicate_file_action of this FileListCopyRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileListCopyRequest):
            return False
