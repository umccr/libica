...
class WorkgroupApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_workgroup_endpoint = _Endpoint(
            settings={
                'response_type': (Workgroup,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/workgroups/{workgroupId}',
                'operation_id': 'get_workgroup',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_workgroups_endpoint = _Endpoint(
            settings={
                'response_type': (WorkgroupList,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/workgroups',
                'operation_id': 'get_workgroups',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_workgroup(
        ...
        **kwargs
        ...
        """Retrieve a workgroup.  # noqa: E501
        ...
        kwargs['workgroup_id'] = \
            workgroup_id
        return self.get_workgroup_endpoint.call_with_http_info(**kwargs)

    def get_workgroups(
        self,
        **kwargs
    ):
        """Retrieve a list of workgroups.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_workgroups(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_workgroups_endpoint.call_with_http_info(**kwargs)
