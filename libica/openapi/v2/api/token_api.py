...
class TokenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.refresh_jwt_token_endpoint = _Endpoint(
            settings={
                'response_type': (Token,),
                'auth': [
                    'JwtAuth'
                ],
                'endpoint_path': '/api/tokens:refresh',
    ...
    def refresh_jwt_token(
        ...
        **kwargs
        ...
        """Refresh a JWT using a not yet expired, still valid JWT.  # noqa: E501

        When still having a valid JWT, this endpoint can be used to extend the validity.<br>Refreshing the JWT is not possible if it has been created using an API-key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.refresh_jwt_token_endpoint.call_with_http_info(**kwargs)
