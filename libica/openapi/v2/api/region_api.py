...
class RegionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_region_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/regions/{regionId}',
        ...
        self.get_regions_endpoint = _Endpoint(
            settings={
                'response_type': (RegionList,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/regions',
    ...
    def get_region(
        ...
        **kwargs
        ...
        """Retrieve a region. Only the regions the user has access to through his/her entitlements can be retrieved.  # noqa: E501
    ...
    def get_regions(
        ...
        **kwargs
        ...
        """Retrieve a list of regions. Only the regions the user has access to through his/her entitlements are returned.  # noqa: E501
