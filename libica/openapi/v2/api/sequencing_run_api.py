...
class SequencingRunApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_sequencing_run_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/sequencingRuns/{sequencingRunId}',
    ...
    def get_sequencing_run(
        ...
        **kwargs
        ...
        >>> thread = api.get_sequencing_run(sequencing_run_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['sequencing_run_id'] = \
            sequencing_run_id
        return self.get_sequencing_run_endpoint.call_with_http_info(**kwargs)
