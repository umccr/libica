...
class ProjectDataLinkingBatchApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_project_data_linking_batch_endpoint = _Endpoint(
            settings={
                'response_type': (ProjectDataLinkingBatch,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/projects/{projectId}/dataLinkingBatch',
                'operation_id': 'create_project_data_linking_batch',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'project_id': 'path',
                    'create_project_data_linking_batch': 'body',
                },
        ...
        self.get_project_data_linking_batch_endpoint = _Endpoint(
            settings={
                'response_type': (ProjectDataLinkingBatch,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/api/projects/{projectId}/dataLinkingBatch/{batchId}',
                'operation_id': 'get_project_data_linking_batch',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_project_data_linking_batch_item_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/projects/{projectId}/dataLinkingBatch/{batchId}/items/{itemId}',
                'operation_id': 'get_project_data_linking_batch_item',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_project_data_linking_batch_items_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/projects/{projectId}/dataLinkingBatch/{batchId}/items',
                'operation_id': 'get_project_data_linking_batch_items',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_project_data_linking_batch(
        ...
        **kwargs
        ...
        >>> thread = api.create_project_data_linking_batch(project_id, create_project_data_linking_batch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_id'] = \
            project_id
        kwargs['create_project_data_linking_batch'] = \
            create_project_data_linking_batch
        return self.create_project_data_linking_batch_endpoint.call_with_http_info(**kwargs)
    ...
    def get_project_data_linking_batch(
        ...
        **kwargs
        ...
        """Retrieve a project data linking batch.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_project_data_linking_batch(project_id, batch_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['batch_id'] = \
            batch_id
        return self.get_project_data_linking_batch_endpoint.call_with_http_info(**kwargs)
    ...
    def get_project_data_linking_batch_item(
        ...
        **kwargs
        ...
        >>> thread = api.get_project_data_linking_batch_item(project_id, batch_id, item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['item_id'] = \
            item_id
        return self.get_project_data_linking_batch_item_endpoint.call_with_http_info(**kwargs)
    ...
    def get_project_data_linking_batch_items(
        ...
        **kwargs
        ...
        >>> thread = api.get_project_data_linking_batch_items(project_id, batch_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['batch_id'] = \
            batch_id
        return self.get_project_data_linking_batch_items_endpoint.call_with_http_info(**kwargs)
