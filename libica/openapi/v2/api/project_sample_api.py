...
class ProjectSampleApi(object):
    ...
    def create_sample_in_project(
        ...
        **kwargs
        ...
        >>> thread = api.create_sample_in_project(project_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            create_sample (CreateSample): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def get_project_samples(
        ...
        **kwargs
        ...
        >>> thread = api.get_project_samples(project_id, async_req=True)
        >>> result = thread.get()
    ...
    def update_project_sample(
        ...
        **kwargs
        ...
        >>> thread = api.update_project_sample(project_id, sample_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            project_sample (ProjectSample): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def update_sample_metadata_fields(
        ...
        **kwargs
        ...
        >>> thread = api.update_sample_metadata_fields(project_id, sample_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_metadata (UpdateMetadata): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
