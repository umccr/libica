...
class ProjectAnalysisCreationBatchApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_analysis_creation_batch_endpoint = _Endpoint(
            settings={
                'response_type': (AnalysisCreationBatch,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/projects/{projectId}/analysisCreationBatch',
                'operation_id': 'create_analysis_creation_batch',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'project_id': 'path',
                    'create_analysis_creation_batch': 'body',
        ...
        self.get_analysis_creation_batch_endpoint = _Endpoint(
            settings={
                'response_type': (AnalysisCreationBatch,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/api/projects/{projectId}/analysisCreationBatch/{batchId}',
                'operation_id': 'get_analysis_creation_batch',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_analysis_creation_batch(
        ...
        **kwargs
        ...
        """Create and start multiple analyses in batch.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_analysis_creation_batch(project_id, create_analysis_creation_batch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_id'] = \
            project_id
        kwargs['create_analysis_creation_batch'] = \
            create_analysis_creation_batch
        return self.create_analysis_creation_batch_endpoint.call_with_http_info(**kwargs)
    ...
    def get_analysis_creation_batch(
        ...
        **kwargs
        ...
        """Retrieve a analysis creation batch.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_analysis_creation_batch(project_id, batch_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['batch_id'] = \
            batch_id
        return self.get_analysis_creation_batch_endpoint.call_with_http_info(**kwargs)
