...
class ProjectAnalysisApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_analysis_logs_endpoint = _Endpoint(
            settings={
                'response_type': (AnalysisLogs,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/projects/{projectId}/analyses/{analysisId}/logs',
                'operation_id': 'get_analysis_logs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_analysis_logs(
        ...
        **kwargs
        ...
        """Retrieve the analysis logs.  # noqa: E501

        Retrieves the logs of the analysis. This endpoint only supports analyses started after ICA CP v2.23 has been released.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_analysis_logs(project_id, analysis_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['analysis_id'] = \
            analysis_id
        return self.get_analysis_logs_endpoint.call_with_http_info(**kwargs)
