...
class ProjectCustomNotificationSubscriptionsApi(object):
    ...
    def create_notification_subscription(
        ...
        **kwargs
        ...
        >>> thread = api.create_notification_subscription(project_id, async_req=True)
        >>> result = thread.get()
    ...
    def update_notification_subscription(
        ...
        **kwargs
        ...
        >>> thread = api.update_notification_subscription(project_id, subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            custom_notification_subscription (CustomNotificationSubscription): The updated subscription. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
