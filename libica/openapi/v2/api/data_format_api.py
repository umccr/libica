...
class DataFormatApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_data_formats_endpoint = _Endpoint(
            settings={
                'response_type': (DataFormatPagedList,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/dataFormats',
                'operation_id': 'get_data_formats',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_data_formats(
        ...
        **kwargs
        ...
        """Retrieve a list of data formats.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_data_formats(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_data_formats_endpoint.call_with_http_info(**kwargs)
