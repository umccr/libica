...
class PipelineLanguageApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_nextflow_versions_endpoint = _Endpoint(
            settings={
                'response_type': (PipelineLanguageVersionList,),
                'auth': [
                    'ApiKeyAuth',
                    'JwtAuth'
                ],
                'endpoint_path': '/api/pipelineLanguages/nextflow/versions',
                'operation_id': 'get_nextflow_versions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_nextflow_versions(
        ...
        **kwargs
        ...
        """Retrieve a list of nextflow versions.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_nextflow_versions(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_nextflow_versions_endpoint.call_with_http_info(**kwargs)
