...
class PipelineApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.archive_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/api/pipelines/{pipelineId}:archive',
                'operation_id': 'archive_pipeline',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.deprecate_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/api/pipelines/{pipelineId}:deprecate',
                'operation_id': 'deprecate_pipeline',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def archive_pipeline(
        ...
        **kwargs
        ...
        >>> thread = api.archive_pipeline(pipeline_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pipeline_id'] = \
            pipeline_id
        return self.archive_pipeline_endpoint.call_with_http_info(**kwargs)

    def deprecate_pipeline(
        self,
        pipeline_id,
        **kwargs
    ):
        ...
        >>> thread = api.deprecate_pipeline(pipeline_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pipeline_id'] = \
            pipeline_id
        return self.deprecate_pipeline_endpoint.call_with_http_info(**kwargs)
