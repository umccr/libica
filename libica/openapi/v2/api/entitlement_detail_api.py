...
class EntitlementDetailApi(object):
    ...
    def find_all_matching_activation_codes_for_cwl(
        ...
        **kwargs
        ...
        >>> thread = api.find_all_matching_activation_codes_for_cwl(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            search_matching_activation_codes_for_cwl_analysis (SearchMatchingActivationCodesForCwlAnalysis): [optional]
    ...
    def find_all_matching_activation_codes_for_nextflow(
        ...
        **kwargs
        ...
        >>> thread = api.find_all_matching_activation_codes_for_nextflow(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            search_matching_activation_codes_for_nextflow_analysis (SearchMatchingActivationCodesForNextflowAnalysis): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def find_best_matching_activation_code_for_cwl(
        ...
        **kwargs
        ...
        >>> thread = api.find_best_matching_activation_code_for_cwl(async_req=True)
        >>> result = thread.get()
    ...
    def find_best_matching_activation_codes_for_nextflow(
        ...
        **kwargs
        ...
        >>> thread = api.find_best_matching_activation_codes_for_nextflow(async_req=True)
        >>> result = thread.get()
