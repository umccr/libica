...
def lazy_import():
    ...
    globals()['ReferenceDataList'] = ReferenceDataList


class ReferenceSet(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'reference_data_list': (ReferenceDataList,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, name, reference_data_list, *args, **kwargs):  # noqa: E501
        """ReferenceSet - a model defined in OpenAPI
        ...
        self.name = name
        self.reference_data_list = reference_data_list
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, name, reference_data_list, *args, **kwargs):  # noqa: E501
        """ReferenceSet - a model defined in OpenAPI
