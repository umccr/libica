...
class EventLogV3(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, code, description, event_type_category, user_id, *args, **kwargs):  # noqa: E501
        """EventLogV3 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, code, description, event_type_category, user_id, *args, **kwargs):  # noqa: E501
        """EventLogV3 - a model defined in OpenAPI
