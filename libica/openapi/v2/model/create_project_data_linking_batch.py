...
class CreateProjectDataLinkingBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CreateProjectDataLinkingBatchItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CreateProjectDataLinkingBatch - a model defined in OpenAPI

        Args:
            items ([CreateProjectDataLinkingBatchItem]):
