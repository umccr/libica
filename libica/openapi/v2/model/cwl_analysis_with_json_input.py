...
class CwlAnalysisWithJsonInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, input_json, *args, **kwargs):  # noqa: E501
        """CwlAnalysisWithJsonInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, input_json, *args, **kwargs):  # noqa: E501
        """CwlAnalysisWithJsonInput - a model defined in OpenAPI
