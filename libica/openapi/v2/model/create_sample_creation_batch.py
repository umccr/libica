...
class CreateSampleCreationBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CreateSampleCreationBatchSampleItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CreateSampleCreationBatch - a model defined in OpenAPI

        Args:
            items ([CreateSampleCreationBatchSampleItem]):
