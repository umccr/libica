...
class AnalysisData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'children': ([AnalysisData],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_id, format, name, data_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            children ([AnalysisData]): [optional]  # noqa: E501
            mount_path (str): The requested location where the input file was located on the machine that was running the pipeline.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_id, format, name, data_type, *args, **kwargs):  # noqa: E501
        """AnalysisData - a model defined in OpenAPI
