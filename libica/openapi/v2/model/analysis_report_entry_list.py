...
class AnalysisReportEntryList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([AnalysisReportEntry],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """AnalysisReportEntryList - a model defined in OpenAPI

        Args:
            items ([AnalysisReportEntry]):
