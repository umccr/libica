...
class WorkflowSessionPagedListV3(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([WorkflowSessionV3],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """WorkflowSessionPagedListV3 - a model defined in OpenAPI

        Args:
            items ([WorkflowSessionV3]):
