...
class AnalysisCreationBatchItemPagedListV3(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([AnalysisCreationBatchItemV3],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """AnalysisCreationBatchItemPagedListV3 - a model defined in OpenAPI

        Args:
            items ([AnalysisCreationBatchItemV3]):
