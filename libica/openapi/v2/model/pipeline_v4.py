...
class PipelineV4(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner, tenant, code, description, language, pipeline_tags, analysis_storage, *args, **kwargs):  # noqa: E501
        """PipelineV4 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner, tenant, code, description, language, pipeline_tags, analysis_storage, *args, **kwargs):  # noqa: E501
        """PipelineV4 - a model defined in OpenAPI
