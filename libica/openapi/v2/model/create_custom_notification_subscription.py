...
class CreateCustomNotificationSubscription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, custom_event_code, enabled, notification_channel_id, *args, **kwargs):  # noqa: E501
        """CreateCustomNotificationSubscription - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, custom_event_code, enabled, notification_channel_id, *args, **kwargs):  # noqa: E501
        """CreateCustomNotificationSubscription - a model defined in OpenAPI
