...
class ChangeProjectOwner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, new_owner_id, *args, **kwargs):  # noqa: E501
        """ChangeProjectOwner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, new_owner_id, *args, **kwargs):  # noqa: E501
        """ChangeProjectOwner - a model defined in OpenAPI
