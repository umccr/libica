...
class SearchMatchingActivationCodesForNextflowAnalysis(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project_id, pipeline_id, analysis_input, *args, **kwargs):  # noqa: E501
        """SearchMatchingActivationCodesForNextflowAnalysis - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, project_id, pipeline_id, analysis_input, *args, **kwargs):  # noqa: E501
        """SearchMatchingActivationCodesForNextflowAnalysis - a model defined in OpenAPI
