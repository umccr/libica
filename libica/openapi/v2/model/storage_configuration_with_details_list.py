...
class StorageConfigurationWithDetailsList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([StorageConfigurationWithDetails],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """StorageConfigurationWithDetailsList - a model defined in OpenAPI

        Args:
            items ([StorageConfigurationWithDetails]):
