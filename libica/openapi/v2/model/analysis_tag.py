...
class AnalysisTag(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, technical_tags, user_tags, reference_tags, *args, **kwargs):  # noqa: E501
        """AnalysisTag - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, technical_tags, user_tags, reference_tags, *args, **kwargs):  # noqa: E501
        """AnalysisTag - a model defined in OpenAPI
