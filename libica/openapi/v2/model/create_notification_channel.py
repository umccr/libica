...
class CreateNotificationChannel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, enabled, type, address, *args, **kwargs):  # noqa: E501
        """CreateNotificationChannel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, enabled, type, address, *args, **kwargs):  # noqa: E501
        """CreateNotificationChannel - a model defined in OpenAPI
