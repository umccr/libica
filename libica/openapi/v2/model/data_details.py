...
class DataDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'owning_project_id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'owning_project_id': 'owningProjectId',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time_created, time_modified, tenant_id, owning_project_id, name, status, tags, data_type, *args, **kwargs):  # noqa: E501
        """DataDetails - a model defined in OpenAPI
        ...
        self.owning_project_id = owning_project_id
        self.name = name
        self.status = status
        self.tags = tags
    ...
    @convert_js_args_to_python_args
    def __init__(self, time_created, time_modified, tenant_id, owning_project_id, name, status, tags, data_type, *args, **kwargs):  # noqa: E501
        """DataDetails - a model defined in OpenAPI
