...
class CreateBundleDataUnlinkingBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CreateBundleDataUnlinkingBatchItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CreateBundleDataUnlinkingBatch - a model defined in OpenAPI

        Args:
            items ([CreateBundleDataUnlinkingBatchItem]):
