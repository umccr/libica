...
class CreateProjectDataUnlinkingBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CreateProjectDataUnlinkingBatchItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CreateProjectDataUnlinkingBatch - a model defined in OpenAPI

        Args:
            items ([CreateProjectDataUnlinkingBatchItem]):
