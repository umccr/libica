...
class CreateConnector(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, active, mode, os, *args, **kwargs):  # noqa: E501
        """CreateConnector - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, active, mode, os, *args, **kwargs):  # noqa: E501
        """CreateConnector - a model defined in OpenAPI
