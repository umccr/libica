...
class SampleCreationBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([SampleCreationBatchSampleItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """SampleCreationBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([SampleCreationBatchSampleItem]):
