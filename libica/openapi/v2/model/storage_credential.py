...
class StorageCredential(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, name, *args, **kwargs):  # noqa: E501
        """StorageCredential - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): defaults to "AWS_USER", must be one of ["AWS_USER", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, name, *args, **kwargs):  # noqa: E501
        """StorageCredential - a model defined in OpenAPI
