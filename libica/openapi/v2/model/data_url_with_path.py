...
class DataUrlWithPath(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_id, data_urn, data_path, url, *args, **kwargs):  # noqa: E501
        """DataUrlWithPath - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_id, data_urn, data_path, url, *args, **kwargs):  # noqa: E501
        """DataUrlWithPath - a model defined in OpenAPI
