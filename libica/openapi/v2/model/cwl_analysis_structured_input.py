...
class CwlAnalysisStructuredInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, inputs, *args, **kwargs):  # noqa: E501
        """CwlAnalysisStructuredInput - a model defined in OpenAPI

        Args:
            object_type (str):
            inputs ([AnalysisDataInput]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, inputs, *args, **kwargs):  # noqa: E501
        """CwlAnalysisStructuredInput - a model defined in OpenAPI
