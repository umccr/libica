...
class CwlAnalysisWithStructuredInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, inputs, *args, **kwargs):  # noqa: E501
        """CwlAnalysisWithStructuredInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, inputs, *args, **kwargs):  # noqa: E501
        """CwlAnalysisWithStructuredInput - a model defined in OpenAPI
