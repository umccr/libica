...
class ProjectPermissionV4(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, role_project, role_flow, role_base, role_bench, membership_type, upload_allowed, download_allowed, *args, **kwargs):  # noqa: E501
        """ProjectPermissionV4 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            email_address (str, none_type): Only present when membershipType is EMAIL. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, role_project, role_flow, role_base, role_bench, membership_type, upload_allowed, download_allowed, *args, **kwargs):  # noqa: E501
        """ProjectPermissionV4 - a model defined in OpenAPI
