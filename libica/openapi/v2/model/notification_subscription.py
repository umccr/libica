...
class NotificationSubscription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, event_code, enabled, notification_channel, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, event_code, enabled, notification_channel, *args, **kwargs):  # noqa: E501
        """NotificationSubscription - a model defined in OpenAPI
