...
class PipelineLanguageVersionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([PipelineLanguageVersion],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """PipelineLanguageVersionList - a model defined in OpenAPI

        Args:
            items ([PipelineLanguageVersion]):
