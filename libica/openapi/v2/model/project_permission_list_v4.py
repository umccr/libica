...
def lazy_import():
    ...
    globals()['ProjectPermissionV4'] = ProjectPermissionV4


class ProjectPermissionListV4(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ProjectPermissionV4],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ProjectPermissionListV4 - a model defined in OpenAPI

        Args:
            items ([ProjectPermissionV4]):
