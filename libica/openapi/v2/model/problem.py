...
class Problem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, title, status, parameters, timestamp, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, title, status, parameters, timestamp, *args, **kwargs):  # noqa: E501
        """Problem - a model defined in OpenAPI
