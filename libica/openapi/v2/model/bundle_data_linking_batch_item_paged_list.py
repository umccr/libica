...
class BundleDataLinkingBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([BundleDataLinkingBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """BundleDataLinkingBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([BundleDataLinkingBatchItem]):
