...
class PipelineConfigurationParameter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, required, multi_value, type, *args, **kwargs):  # noqa: E501
        """PipelineConfigurationParameter - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, required, multi_value, type, *args, **kwargs):  # noqa: E501
        """PipelineConfigurationParameter - a model defined in OpenAPI
