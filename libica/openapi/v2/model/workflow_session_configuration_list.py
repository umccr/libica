...
class WorkflowSessionConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([WorkflowSessionConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """WorkflowSessionConfigurationList - a model defined in OpenAPI

        Args:
            items ([WorkflowSessionConfiguration]):
