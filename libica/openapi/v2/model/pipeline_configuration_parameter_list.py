...
class PipelineConfigurationParameterList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([PipelineConfigurationParameter],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """PipelineConfigurationParameterList - a model defined in OpenAPI

        Args:
            items ([PipelineConfigurationParameter]):
