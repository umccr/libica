...
def lazy_import():
    ...
    globals()['WorkflowV3'] = WorkflowV3


class WorkflowSessionV3(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, owner_id, tenant_id, user_reference, workflow, status, tags, *args, **kwargs):  # noqa: E501
        """WorkflowSessionV3 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, owner_id, tenant_id, user_reference, workflow, status, tags, *args, **kwargs):  # noqa: E501
        """WorkflowSessionV3 - a model defined in OpenAPI
