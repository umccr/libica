...
def lazy_import():
    ...
    globals()['CreateProjectDataMoveBatchItem'] = CreateProjectDataMoveBatchItem


class CreateProjectDataMoveBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CreateProjectDataMoveBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CreateProjectDataMoveBatch - a model defined in OpenAPI

        Args:
            items ([CreateProjectDataMoveBatchItem]):
