...
class StorageConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, name, status, region, is_default, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, name, status, region, is_default, *args, **kwargs):  # noqa: E501
        """StorageConfiguration - a model defined in OpenAPI
