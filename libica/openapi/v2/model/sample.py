...
class Sample(ModelNormal):
    ...
    attribute_map = {
        ...
        'metadata_valid': 'metadataValid',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, name, tags, region, status, metadata_valid, metadata, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            metadata ([MetadataField]): The metadata of the sample
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, name, tags, region, status, metadata_valid, metadata, *args, **kwargs):  # noqa: E501
        """Sample - a model defined in OpenAPI
