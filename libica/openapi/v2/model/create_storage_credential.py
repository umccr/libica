...
class CreateStorageCredential(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'aws_credentials': (AwsCredentials,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """CreateStorageCredential - a model defined in OpenAPI

        Args:
            name (str): The name of the credentials

        Keyword Args:
            type (str): The type of the credentials. defaults to "AWS_USER", must be one of ["AWS_USER", ]  # noqa: E501
            ...
            aws_credentials (AwsCredentials): [optional]  # noqa: E501
        """
