...
class WorkflowSessionInputList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([WorkflowSessionInput],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """WorkflowSessionInputList - a model defined in OpenAPI

        Args:
            items ([WorkflowSessionInput]):
