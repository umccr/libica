...
class WorkflowSessionConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, multi_value, values, *args, **kwargs):  # noqa: E501
        """WorkflowSessionConfiguration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, multi_value, values, *args, **kwargs):  # noqa: E501
        """WorkflowSessionConfiguration - a model defined in OpenAPI
