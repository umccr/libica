...
def lazy_import():
    ...
    globals()['CwlAnalysisWithStructuredInput'] = CwlAnalysisWithStructuredInput


class CreateCwlWithStructuredInputAnalysis(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'analysis_input': (CwlAnalysisWithStructuredInput,),  # noqa: E501
    ...
    def _from_openapi_data(cls, user_reference, pipeline_id, analysis_input, *args, **kwargs):  # noqa: E501
        """CreateCwlWithStructuredInputAnalysis - a model defined in OpenAPI
