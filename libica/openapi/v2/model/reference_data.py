...
class ReferenceData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, name, version, type_list, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            species (Species): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, name, version, type_list, *args, **kwargs):  # noqa: E501
        """ReferenceData - a model defined in OpenAPI
