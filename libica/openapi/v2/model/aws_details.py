...
class AWSDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'key_prefix': (str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bucket_name, *args, **kwargs):  # noqa: E501
        """AWSDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            key_prefix (str, none_type): Key prefix within the bucket for ICA to operate within. Data may only be created having this prefix and the given credentials will only give access to it. If not set, default is to allow operation on the full bucket. No leading slash, and must end with a trailing slash.. [optional]  # noqa: E501
