...
class BundlePipeline(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pipeline, bundle_id, *args, **kwargs):  # noqa: E501
        """BundlePipeline - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, pipeline, bundle_id, *args, **kwargs):  # noqa: E501
        """BundlePipeline - a model defined in OpenAPI
