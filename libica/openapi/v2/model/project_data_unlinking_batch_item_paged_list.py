...
class ProjectDataUnlinkingBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ProjectDataUnlinkingBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ProjectDataUnlinkingBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([ProjectDataUnlinkingBatchItem]):
