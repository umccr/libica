...
class ProjectSample(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sample, project_id, *args, **kwargs):  # noqa: E501
        """ProjectSample - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, sample, project_id, *args, **kwargs):  # noqa: E501
        """ProjectSample - a model defined in OpenAPI
