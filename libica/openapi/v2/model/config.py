...
class Config(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, regex, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            format (str, none_type): Format of the file. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, regex, *args, **kwargs):  # noqa: E501
        """Config - a model defined in OpenAPI
