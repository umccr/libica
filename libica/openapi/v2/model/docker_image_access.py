...
class DockerImageAccess(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, web, console, *args, **kwargs):  # noqa: E501
        """DockerImageAccess - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, web, console, *args, **kwargs):  # noqa: E501
        """DockerImageAccess - a model defined in OpenAPI
