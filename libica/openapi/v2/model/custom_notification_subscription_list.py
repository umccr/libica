...
class CustomNotificationSubscriptionList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CustomNotificationSubscription],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CustomNotificationSubscriptionList - a model defined in OpenAPI

        Args:
            items ([CustomNotificationSubscription]):
