...
def lazy_import():
    ...
    globals()['ProjectDataUpdateBatchItem'] = ProjectDataUpdateBatchItem


class ProjectDataUpdateBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ProjectDataUpdateBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ProjectDataUpdateBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([ProjectDataUpdateBatchItem]):
