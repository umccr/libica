...
class ProjectFileAndUploadUrl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data, project_id, upload_url, *args, **kwargs):  # noqa: E501
        """ProjectFileAndUploadUrl - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data, project_id, upload_url, *args, **kwargs):  # noqa: E501
        """ProjectFileAndUploadUrl - a model defined in OpenAPI
