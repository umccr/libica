...
class UploadRule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, code, local_folder, file_pattern, project, *args, **kwargs):  # noqa: E501
        """UploadRule - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data_format (DataFormat): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, code, local_folder, file_pattern, project, *args, **kwargs):  # noqa: E501
        """UploadRule - a model defined in OpenAPI
