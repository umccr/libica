...
class BundleDataUnlinkingBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([BundleDataUnlinkingBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """BundleDataUnlinkingBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([BundleDataUnlinkingBatchItem]):
