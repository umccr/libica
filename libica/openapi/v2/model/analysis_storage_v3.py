...
class AnalysisStorageV3(ModelNormal):
    ...
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, name, *args, **kwargs):  # noqa: E501
        """AnalysisStorageV3 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str, none_type): The description about the storage option. [optional]  # noqa: E501
        """
