...
class DataTransfer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data_transferred': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'data_transferred': 'dataTransferred',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner_id, tenant_id, reference, direction, data_transferred, status, data, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            protocol (str, none_type): [optional] if omitted the server will use the default value of "HTTPS"  # noqa: E501
            status_message (str, none_type): A message explaining the reason why the transfer is in the current status.. [optional]  # noqa: E501
            duration (int, none_type): The overall duration of of the transfer defined in seconds.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner_id, tenant_id, reference, direction, data_transferred, status, data, *args, **kwargs):  # noqa: E501
        """DataTransfer - a model defined in OpenAPI
