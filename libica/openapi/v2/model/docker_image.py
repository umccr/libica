...
class DockerImage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, time_created, time_modified, owner, tenant, name, status, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, time_created, time_modified, owner, tenant, name, status, type, *args, **kwargs):  # noqa: E501
        """DockerImage - a model defined in OpenAPI
