...
class CreateExternalDockerImage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, name, version, type, *args, **kwargs):  # noqa: E501
        """CreateExternalDockerImage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, name, version, type, *args, **kwargs):  # noqa: E501
        """CreateExternalDockerImage - a model defined in OpenAPI
