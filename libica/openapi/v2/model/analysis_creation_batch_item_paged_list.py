...
class AnalysisCreationBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([AnalysisCreationBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """AnalysisCreationBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([AnalysisCreationBatchItem]):
