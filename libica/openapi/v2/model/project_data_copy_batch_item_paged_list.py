...
class ProjectDataCopyBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ProjectDataCopyBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ProjectDataCopyBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([ProjectDataCopyBatchItem]):
