...
class WorkflowSessionPagedListV4(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([WorkflowSessionV4],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """WorkflowSessionPagedListV4 - a model defined in OpenAPI

        Args:
            items ([WorkflowSessionV4]):
