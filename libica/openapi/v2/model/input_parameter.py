...
class InputParameter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, required, multi_value, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, required, multi_value, *args, **kwargs):  # noqa: E501
        """InputParameter - a model defined in OpenAPI
