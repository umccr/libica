...
class ProjectDataMoveBatchItemPagedList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ProjectDataMoveBatchItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ProjectDataMoveBatchItemPagedList - a model defined in OpenAPI

        Args:
            items ([ProjectDataMoveBatchItem]):
