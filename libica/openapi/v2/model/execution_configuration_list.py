...
class ExecutionConfigurationList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ExecutionConfiguration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ExecutionConfigurationList - a model defined in OpenAPI

        Args:
            items ([ExecutionConfiguration]):
