...
class CreateCustomEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, content, *args, **kwargs):  # noqa: E501
        """CreateCustomEvent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, content, *args, **kwargs):  # noqa: E501
        """CreateCustomEvent - a model defined in OpenAPI
