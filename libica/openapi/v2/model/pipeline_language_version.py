...
class PipelineLanguageVersion(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, language, *args, **kwargs):  # noqa: E501
        """PipelineLanguageVersion - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, language, *args, **kwargs):  # noqa: E501
        """PipelineLanguageVersion - a model defined in OpenAPI
