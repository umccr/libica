...
class CreateBundleDataLinkingBatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CreateBundleDataLinkingBatchItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CreateBundleDataLinkingBatch - a model defined in OpenAPI

        Args:
            items ([CreateBundleDataLinkingBatchItem]):
