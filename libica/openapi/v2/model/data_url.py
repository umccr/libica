...
class DataUrl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_id, data_urn, url, *args, **kwargs):  # noqa: E501
        """DataUrl - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_id, data_urn, url, *args, **kwargs):  # noqa: E501
        """DataUrl - a model defined in OpenAPI
