...
from libica.openapi.v2.api.sequencing_run_api import SequencingRunApi  # noqa: E501


class TestSequencingRunApi(unittest.TestCase):
    """SequencingRunApi unit test stubs"""

    def setUp(self):
        self.api = SequencingRunApi()  # noqa: E501
