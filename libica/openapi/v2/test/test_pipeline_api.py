...
from libica.openapi.v2.api.pipeline_api import PipelineApi  # noqa: E501
...
class TestPipelineApi(unittest.TestCase):
    ...
    def test_get_pipeline_input_parameters(self):
    ...
    def test_get_pipeline_reference_sets(self):
