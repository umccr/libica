...
from libica.openapi.v2.api.project_analysis_api import ProjectAnalysisApi  # noqa: E501
...
class TestProjectAnalysisApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = ProjectAnalysisApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_abort_analysis(self):
    ...
    def test_create_cwl_analysis(self):
    ...
    def test_get_analysis_configurations(self):
    ...
    def test_get_analysis_inputs(self):
    ...
    def test_get_analysis_outputs(self):
    ...
    def test_get_analysis_steps(self):
