...
from libica.openapi.v2.api.docker_image_api import DockerImageApi  # noqa: E501
...
class TestDockerImageApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = DockerImageApi()  # noqa: E501
    ...
    def test_create_external_docker_image(self):
    ...
    def test_create_internal_docker_image(self):
