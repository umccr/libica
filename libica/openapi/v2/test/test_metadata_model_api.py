...
from libica.openapi.v2.api.metadata_model_api import MetadataModelApi  # noqa: E501


class TestMetadataModelApi(unittest.TestCase):
    """MetadataModelApi unit test stubs"""

    def setUp(self):
        self.api = MetadataModelApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_metadata_model(self):
        """Test case for get_metadata_model

        Retrieve a metadata model. Only metadata models that the user has access to can be retrieved.  # noqa: E501
        """
        pass

    def test_get_metadata_model_fields(self):
        """Test case for get_metadata_model_fields

        Retrieve the fields of a metadata model. Only metadata models that the user has access to can be retrieved.  # noqa: E501
        """
        pass

    def test_get_metadata_models(self):
        """Test case for get_metadata_models
    ...
    def test_get_tenant_model(self):
        """Test case for get_tenant_model
