...
from libica.openapi.v2 import rest
from libica.openapi.v2.configuration import Configuration
from libica.openapi.v2.exceptions import ApiTypeError, ApiValueError, ApiException
from libica.openapi.v2.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AnalysisStorageApi()
        api_instance.get_analysis_storage_options  # this is an instance of the class Endpoint
        api_instance.get_analysis_storage_options()  # this invokes api_instance.get_analysis_storage_options.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_analysis_storage_options.callable or self.callable in this class
