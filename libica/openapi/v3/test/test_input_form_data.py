...
class TestInputFormData(unittest.TestCase):
    """InputFormData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFormData:
        """Test InputFormData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormData`
        """
        model = InputFormData()
        if include_optional:
