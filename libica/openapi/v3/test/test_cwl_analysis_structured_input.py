...
class TestCwlAnalysisStructuredInput(unittest.TestCase):
    """CwlAnalysisStructuredInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CwlAnalysisStructuredInput:
        """Test CwlAnalysisStructuredInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CwlAnalysisStructuredInput`
        """
        model = CwlAnalysisStructuredInput()
        if include_optional:
            return CwlAnalysisStructuredInput(
    ...
    def testCwlAnalysisStructuredInput(self):
        """Test CwlAnalysisStructuredInput"""
