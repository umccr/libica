...
class TestCwlAnalysisWithStructuredInput(unittest.TestCase):
    """CwlAnalysisWithStructuredInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CwlAnalysisWithStructuredInput:
        """Test CwlAnalysisWithStructuredInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CwlAnalysisWithStructuredInput`
        """
        model = CwlAnalysisWithStructuredInput()
        if include_optional:
            return CwlAnalysisWithStructuredInput(
                inputs = [
    ...
    def testCwlAnalysisWithStructuredInput(self):
        """Test CwlAnalysisWithStructuredInput"""
