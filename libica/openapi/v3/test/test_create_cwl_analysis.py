...
class TestCreateCwlAnalysis(unittest.TestCase):
    """CreateCwlAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCwlAnalysis:
        """Test CreateCwlAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCwlAnalysis`
        """
        model = CreateCwlAnalysis()
        if include_optional:
    ...
    def testCreateCwlAnalysis(self):
        """Test CreateCwlAnalysis"""
