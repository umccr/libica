...
class TestCreateFileData(unittest.TestCase):
    """CreateFileData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFileData:
        """Test CreateFileData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFileData`
        """
        model = CreateFileData()
        if include_optional:
