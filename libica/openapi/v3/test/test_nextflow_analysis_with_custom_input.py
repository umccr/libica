...
class TestNextflowAnalysisWithCustomInput(unittest.TestCase):
    """NextflowAnalysisWithCustomInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NextflowAnalysisWithCustomInput:
        """Test NextflowAnalysisWithCustomInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NextflowAnalysisWithCustomInput`
        """
        model = NextflowAnalysisWithCustomInput()
        if include_optional:
    ...
    def testNextflowAnalysisWithCustomInput(self):
        """Test NextflowAnalysisWithCustomInput"""
