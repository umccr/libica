...
class TestProjectPermissionListV4(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectPermissionListV4:
        """Test ProjectPermissionListV4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPermissionListV4`
        """
        model = ProjectPermissionListV4()
        if include_optional:
            return ProjectPermissionListV4(
                items = [
                    libica.openapi.v3.models.project_permission_v4.ProjectPermissionV4(
                        id = '', 
    ...
    def testProjectPermissionListV4(self):
        """Test ProjectPermissionListV4"""
