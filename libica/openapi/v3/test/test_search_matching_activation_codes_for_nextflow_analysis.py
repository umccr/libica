...
class TestSearchMatchingActivationCodesForNextflowAnalysis(unittest.TestCase):
    """SearchMatchingActivationCodesForNextflowAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchMatchingActivationCodesForNextflowAnalysis:
        """Test SearchMatchingActivationCodesForNextflowAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchMatchingActivationCodesForNextflowAnalysis`
        """
        model = SearchMatchingActivationCodesForNextflowAnalysis()
        if include_optional:
            return SearchMatchingActivationCodesForNextflowAnalysis(
                project_id = '',
                pipeline_id = '',
    ...
    def testSearchMatchingActivationCodesForNextflowAnalysis(self):
        """Test SearchMatchingActivationCodesForNextflowAnalysis"""
