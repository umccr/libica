...
class TestInputFormGroup(unittest.TestCase):
    """InputFormGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFormGroup:
        """Test InputFormGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormGroup`
        """
        model = InputFormGroup()
        if include_optional:
