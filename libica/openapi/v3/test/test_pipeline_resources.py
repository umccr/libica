...
class TestPipelineResources(unittest.TestCase):
    """PipelineResources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PipelineResources:
        """Test PipelineResources
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PipelineResources`
        """
        model = PipelineResources()
        if include_optional:
    ...
    def testPipelineResources(self):
        """Test PipelineResources"""
