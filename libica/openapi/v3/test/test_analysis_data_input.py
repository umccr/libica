...
class TestAnalysisDataInput(unittest.TestCase):
    """AnalysisDataInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisDataInput:
        """Test AnalysisDataInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisDataInput`
        """
        model = AnalysisDataInput()
        if include_optional:
    ...
    def testAnalysisDataInput(self):
        """Test AnalysisDataInput"""
