...
class TestCreateBundle(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateBundle:
        """Test CreateBundle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateBundle`
        """
        model = CreateBundle()
        if include_optional:
            return CreateBundle(
