...
class TestInputFormFieldValues(unittest.TestCase):
    """InputFormFieldValues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFormFieldValues:
        """Test InputFormFieldValues
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormFieldValues`
        """
        model = InputFormFieldValues()
        if include_optional:
            return InputFormFieldValues(
                id = '',
                values = [
                    ''
                    ],
    ...
    def testInputFormFieldValues(self):
        """Test InputFormFieldValues"""
