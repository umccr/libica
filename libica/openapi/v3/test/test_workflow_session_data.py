...
class TestWorkflowSessionData(unittest.TestCase):
    """WorkflowSessionData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowSessionData:
        """Test WorkflowSessionData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowSessionData`
        """
        model = WorkflowSessionData()
        if include_optional:
    ...
    def testWorkflowSessionData(self):
        """Test WorkflowSessionData"""
