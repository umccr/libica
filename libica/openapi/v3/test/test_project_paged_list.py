...
class TestProjectPagedList(unittest.TestCase):
    """ProjectPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPagedList:
        """Test ProjectPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPagedList`
        """
        model = ProjectPagedList()
        if include_optional:
            return ProjectPagedList(
                items = [
                    libica.openapi.v3.models.project.Project(
                        id = '', 
