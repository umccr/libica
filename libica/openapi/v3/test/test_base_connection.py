...
class TestBaseConnection(unittest.TestCase):
    """BaseConnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseConnection:
        """Test BaseConnection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseConnection`
        """
        model = BaseConnection()
        if include_optional:
