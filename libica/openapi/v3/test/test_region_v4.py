...
class TestRegionV4(unittest.TestCase):
    """RegionV4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionV4:
        """Test RegionV4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionV4`
        """
        model = RegionV4()
        if include_optional:
            return RegionV4(
