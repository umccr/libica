...
class TestBundleApi(unittest.TestCase):
    ...
    def test_accept_terms_of_use_bundle(self) -> None:
        """Test case for accept_terms_of_use_bundle
    ...
    def test_get_bundle_terms_of_use(self) -> None:
        """Test case for get_bundle_terms_of_use
    ...
    def test_get_terms_of_use_acceptance(self) -> None:
        """Test case for get_terms_of_use_acceptance

        Retrieve the acceptance record for a bundle for the current user.
        """
        pass

    def test_insert_bundle_terms_of_use(self) -> None:
        """Test case for insert_bundle_terms_of_use
