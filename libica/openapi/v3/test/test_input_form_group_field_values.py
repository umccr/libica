...
class TestInputFormGroupFieldValues(unittest.TestCase):
    """InputFormGroupFieldValues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFormGroupFieldValues:
        """Test InputFormGroupFieldValues
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormGroupFieldValues`
        """
        model = InputFormGroupFieldValues()
        if include_optional:
            return InputFormGroupFieldValues(
                values = [
    ...
    def testInputFormGroupFieldValues(self):
        """Test InputFormGroupFieldValues"""
