...
class TestActivationCodeDetailUsage(unittest.TestCase):
    """ActivationCodeDetailUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivationCodeDetailUsage:
        """Test ActivationCodeDetailUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivationCodeDetailUsage`
        """
        model = ActivationCodeDetailUsage()
        if include_optional:
    ...
    def testActivationCodeDetailUsage(self):
        """Test ActivationCodeDetailUsage"""
