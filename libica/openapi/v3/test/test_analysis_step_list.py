...
class TestAnalysisStepList(unittest.TestCase):
    """AnalysisStepList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepList:
        """Test AnalysisStepList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepList`
        """
        model = AnalysisStepList()
        if include_optional:
            return AnalysisStepList(
                items = [
                    libica.openapi.v3.models.analysis_step.AnalysisStep(
                        id = '', 
                        name = '', 
                        status = 'FAILED', 
                        queue_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        start_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        end_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        technical = True, 
                        logs = libica.openapi.v3.models.analysis_step_logs.AnalysisStepLogs(
                            std_out_data = libica.openapi.v3.models.data.Data(
                                id = '0', 
                                urn = '0', 
                                ...
                                folder_details = libica.openapi.v3.models.folder_details.FolderDetails(
                                    non_indexed = True, ), ), 
                            std_out_stream = '', 
                            std_err_data = libica.openapi.v3.models.data.Data(
                                id = '0', 
                                urn = '0', ), 
                            std_err_stream = '', ), 
                        exit_code = 56, )
