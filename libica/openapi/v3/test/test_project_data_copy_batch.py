...
class TestProjectDataCopyBatch(unittest.TestCase):
    """ProjectDataCopyBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataCopyBatch:
        """Test ProjectDataCopyBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataCopyBatch`
        """
        model = ProjectDataCopyBatch()
        if include_optional:
            return ProjectDataCopyBatch(
                id = '',
    ...
    def testProjectDataCopyBatch(self):
        """Test ProjectDataCopyBatch"""
