...
class TestProjectPermissionV4(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectPermissionV4:
        """Test ProjectPermissionV4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPermissionV4`
        """
        model = ProjectPermissionV4()
        if include_optional:
    ...
    def testProjectPermissionV4(self):
        """Test ProjectPermissionV4"""
