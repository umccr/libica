...
class TestConnectorApi(unittest.TestCase):
    ...
    def test_cancel_connector(self) -> None:
    ...
    def test_create_download_rule(self) -> None:
    ...
    def test_create_upload_rule(self) -> None:
    ...
    def test_delete_download_rule(self) -> None:
    ...
    def test_delete_upload_rule(self) -> None:
    ...
    def test_disable_connector(self) -> None:
    ...
    def test_enable_connector(self) -> None:
    ...
    def test_get_download_rule(self) -> None:
    ...
    def test_get_download_rules(self) -> None:
    ...
    def test_get_upload_rule(self) -> None:
    ...
    def test_get_upload_rules(self) -> None:
    ...
    def test_update_download_rule(self) -> None:
    ...
    def test_update_upload_rule(self) -> None:
