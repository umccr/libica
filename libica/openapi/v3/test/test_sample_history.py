...
class TestSampleHistory(unittest.TestCase):
    """SampleHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleHistory:
        """Test SampleHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleHistory`
        """
        model = SampleHistory()
        if include_optional:
