...
class TestCreateProjectDataUpdateBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateProjectDataUpdateBatch:
        """Test CreateProjectDataUpdateBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateProjectDataUpdateBatch`
        """
        model = CreateProjectDataUpdateBatch()
        if include_optional:
            return CreateProjectDataUpdateBatch(
                data_update_groups = [
                    libica.openapi.v3.models.data_update_group.DataUpdateGroup(
                        data_ids = [
                            ''
                            ], 
    ...
    def testCreateProjectDataUpdateBatch(self):
        """Test CreateProjectDataUpdateBatch"""
