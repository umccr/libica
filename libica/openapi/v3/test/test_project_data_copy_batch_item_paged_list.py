...
class TestProjectDataCopyBatchItemPagedList(unittest.TestCase):
    """ProjectDataCopyBatchItemPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataCopyBatchItemPagedList:
        """Test ProjectDataCopyBatchItemPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataCopyBatchItemPagedList`
        """
        model = ProjectDataCopyBatchItemPagedList()
        if include_optional:
            return ProjectDataCopyBatchItemPagedList(
                items = [
                    libica.openapi.v3.models.project_data_copy_batch_item.ProjectDataCopyBatchItem(
                        id = '', 
                        request = libica.openapi.v3.models.project_data_copy_batch_item_request.ProjectDataCopyBatchItemRequest(
                            data_id = '', ), 
                        processing = libica.openapi.v3.models.project_data_copy_batch_item_processing.ProjectDataCopyBatchItemProcessing(
                            status = 'QUEUED', 
    ...
    def testProjectDataCopyBatchItemPagedList(self):
        """Test ProjectDataCopyBatchItemPagedList"""
