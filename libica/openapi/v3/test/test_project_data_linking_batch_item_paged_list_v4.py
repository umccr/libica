...
class TestProjectDataLinkingBatchItemPagedListV4(unittest.TestCase):
    """ProjectDataLinkingBatchItemPagedListV4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataLinkingBatchItemPagedListV4:
        """Test ProjectDataLinkingBatchItemPagedListV4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataLinkingBatchItemPagedListV4`
        """
        model = ProjectDataLinkingBatchItemPagedListV4()
        if include_optional:
            return ProjectDataLinkingBatchItemPagedListV4(
                items = [
                    libica.openapi.v3.models.project_data_linking_batch_item_v4.ProjectDataLinkingBatchItemV4(
                        id = '', 
                        request = libica.openapi.v3.models.project_data_linking_batch_item_request.ProjectDataLinkingBatchItemRequest(
                            data_id = '', ), 
                        processing = libica.openapi.v3.models.project_data_linking_batch_item_processing_v4.ProjectDataLinkingBatchItemProcessingV4(
                            status = '', 
                            additional_status_information = '', ), 
                        created_project_data = libica.openapi.v3.models.project_data.ProjectData(
    ...
    def testProjectDataLinkingBatchItemPagedListV4(self):
        """Test ProjectDataLinkingBatchItemPagedListV4"""
