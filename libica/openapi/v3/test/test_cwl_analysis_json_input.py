...
class TestCwlAnalysisJsonInput(unittest.TestCase):
    """CwlAnalysisJsonInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CwlAnalysisJsonInput:
        """Test CwlAnalysisJsonInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CwlAnalysisJsonInput`
        """
        model = CwlAnalysisJsonInput()
        if include_optional:
    ...
    def testCwlAnalysisJsonInput(self):
        """Test CwlAnalysisJsonInput"""
