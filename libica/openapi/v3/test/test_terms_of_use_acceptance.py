...
class TestTermsOfUseAcceptance(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TermsOfUseAcceptance:
        """Test TermsOfUseAcceptance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TermsOfUseAcceptance`
        """
        model = TermsOfUseAcceptance()
        if include_optional:
            return TermsOfUseAcceptance(
                accepted = True,
                first_acceptance_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                version_terms_of_use_first_accept = '',
                last_acceptance_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
    ...
    def testTermsOfUseAcceptance(self):
        """Test TermsOfUseAcceptance"""
