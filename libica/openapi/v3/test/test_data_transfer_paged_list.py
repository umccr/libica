...
class TestDataTransferPagedList(unittest.TestCase):
    """DataTransferPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataTransferPagedList:
        """Test DataTransferPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataTransferPagedList`
        """
        model = DataTransferPagedList()
        if include_optional:
            return DataTransferPagedList(
                items = [
                    libica.openapi.v3.models.data_transfer.DataTransfer(
                        id = '', 
    ...
    def testDataTransferPagedList(self):
        """Test DataTransferPagedList"""
