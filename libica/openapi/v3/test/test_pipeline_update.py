...
class TestPipelineUpdate(unittest.TestCase):
    """PipelineUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PipelineUpdate:
        """Test PipelineUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PipelineUpdate`
        """
        model = PipelineUpdate()
        if include_optional:
