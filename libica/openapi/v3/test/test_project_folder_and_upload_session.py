...
class TestProjectFolderAndUploadSession(unittest.TestCase):
    """ProjectFolderAndUploadSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectFolderAndUploadSession:
        """Test ProjectFolderAndUploadSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectFolderAndUploadSession`
        """
        model = ProjectFolderAndUploadSession()
        if include_optional:
            return ProjectFolderAndUploadSession(
                data = libica.openapi.v3.models.data.Data(
                    ...
                    folder_details = libica.openapi.v3.models.folder_details.FolderDetails(
                        non_indexed = True, ), ),
                project_id = '',
                upload_session = libica.openapi.v3.models.folder_upload_session.FolderUploadSession(
                    id = '', 
                    time_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    status = 'OPEN', 
                    time_session_expires = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    temp_credentials = libica.openapi.v3.models.temp_credentials.TempCredentials(
                        aws_temp_credentials = libica.openapi.v3.models.aws_temp_credentials.AwsTempCredentials(
                            access_key = '', 
                            secret_key = '', 
                            session_token = '', 
                            region = '', 
                        ...
                        rclone_temp_credentials = libica.openapi.v3.models.rclone_temp_credentials.RcloneTempCredentials(
                            config = {
                                'key' : ''
                                }, 
                            file_path_prefix = '', 
    ...
    def testProjectFolderAndUploadSession(self):
        """Test ProjectFolderAndUploadSession"""
