...
class TestExecutionConfiguration(unittest.TestCase):
    """ExecutionConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecutionConfiguration:
        """Test ExecutionConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecutionConfiguration`
        """
    ...
    def testExecutionConfiguration(self):
        """Test ExecutionConfiguration"""
