...
class TestBundleDataLinkingBatchItemPagedList(unittest.TestCase):
    """BundleDataLinkingBatchItemPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleDataLinkingBatchItemPagedList:
        """Test BundleDataLinkingBatchItemPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleDataLinkingBatchItemPagedList`
        """
        model = BundleDataLinkingBatchItemPagedList()
        if include_optional:
            return BundleDataLinkingBatchItemPagedList(
                items = [
                    libica.openapi.v3.models.bundle_data_linking_batch_item.BundleDataLinkingBatchItem(
                        id = '', 
                        request = libica.openapi.v3.models.bundle_data_linking_batch_item_request.BundleDataLinkingBatchItemRequest(
                            data_id = '', ), 
                        processing = libica.openapi.v3.models.bundle_data_linking_batch_item_processing.BundleDataLinkingBatchItemProcessing(
                            status = '', 
                            additional_status_information = '', ), 
                        bundle_data = libica.openapi.v3.models.bundle_data.BundleData(
    ...
    def testBundleDataLinkingBatchItemPagedList(self):
        """Test BundleDataLinkingBatchItemPagedList"""
