...
class TestCreateNextflowWithCustomInputAnalysis(unittest.TestCase):
    """CreateNextflowWithCustomInputAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNextflowWithCustomInputAnalysis:
        """Test CreateNextflowWithCustomInputAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNextflowWithCustomInputAnalysis`
        """
        model = CreateNextflowWithCustomInputAnalysis()
        if include_optional:
            return CreateNextflowWithCustomInputAnalysis(
                ...
                analysis_input = libica.openapi.v3.models.nextflow_analysis_with_custom_input.NextflowAnalysisWithCustomInput(
                    custom_input = '', 
                    data_ids = [
                        ''
                        ], 
    ...
    def testCreateNextflowWithCustomInputAnalysis(self):
        """Test CreateNextflowWithCustomInputAnalysis"""
