...
class TestInputFormExternalData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InputFormExternalData:
        """Test InputFormExternalData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormExternalData`
        """
        model = InputFormExternalData()
        if include_optional:
            return InputFormExternalData(
                url = '',
                type = 'basespace',
