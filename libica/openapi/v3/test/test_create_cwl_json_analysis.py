...
class TestCreateCwlJsonAnalysis(unittest.TestCase):
    """CreateCwlJsonAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCwlJsonAnalysis:
        """Test CreateCwlJsonAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCwlJsonAnalysis`
        """
        model = CreateCwlJsonAnalysis()
        if include_optional:
            return CreateCwlJsonAnalysis(
                ...
                input_form_values = libica.openapi.v3.models.cwl_json_analysis_input.CwlJsonAnalysisInput(
                    fields = [
    ...
    def testCreateCwlJsonAnalysis(self):
        """Test CreateCwlJsonAnalysis"""
