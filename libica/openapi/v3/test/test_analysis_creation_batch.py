...
class TestAnalysisCreationBatch(unittest.TestCase):
    """AnalysisCreationBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisCreationBatch:
        """Test AnalysisCreationBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisCreationBatch`
        """
        model = AnalysisCreationBatch()
        if include_optional:
            return AnalysisCreationBatch(
                id = '',
    ...
    def testAnalysisCreationBatch(self):
        """Test AnalysisCreationBatch"""
