...
class TestProjectDataUpdateBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectDataUpdateBatch:
        """Test ProjectDataUpdateBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataUpdateBatch`
        """
        model = ProjectDataUpdateBatch()
        if include_optional:
            return ProjectDataUpdateBatch(
                id = '',
    ...
    def testProjectDataUpdateBatch(self):
        """Test ProjectDataUpdateBatch"""
