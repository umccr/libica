...
class TestCwlAnalysisWithJsonInput(unittest.TestCase):
    """CwlAnalysisWithJsonInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CwlAnalysisWithJsonInput:
        """Test CwlAnalysisWithJsonInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CwlAnalysisWithJsonInput`
        """
        model = CwlAnalysisWithJsonInput()
        if include_optional:
    ...
    def testCwlAnalysisWithJsonInput(self):
        """Test CwlAnalysisWithJsonInput"""
