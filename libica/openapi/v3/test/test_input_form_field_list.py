...
class TestInputFormFieldList(unittest.TestCase):
    """InputFormFieldList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFormFieldList:
        """Test InputFormFieldList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormFieldList`
        """
        model = InputFormFieldList()
        if include_optional:
            return InputFormFieldList(
                items = [
                    libica.openapi.v3.models.input_form_field.InputFormField(
                        id = '', 
                        type = '', 
                        label = '', 
                        min_values = 56, 
                        ...
                        fields = [
                            libica.openapi.v3.models.input_form_group_field.InputFormGroupField(
                                id = '', 
                                type = '', 
                                label = '', 
                                min_values = 56, 
    ...
    def testInputFormFieldList(self):
        """Test InputFormFieldList"""
