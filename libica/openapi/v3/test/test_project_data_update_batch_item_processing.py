...
class TestProjectDataUpdateBatchItemProcessing(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectDataUpdateBatchItemProcessing:
        """Test ProjectDataUpdateBatchItemProcessing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataUpdateBatchItemProcessing`
        """
        model = ProjectDataUpdateBatchItemProcessing()
        if include_optional:
    ...
    def testProjectDataUpdateBatchItemProcessing(self):
        """Test ProjectDataUpdateBatchItemProcessing"""
