...
class TestDataPagedList(unittest.TestCase):
    """DataPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataPagedList:
        """Test DataPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataPagedList`
        """
        model = DataPagedList()
        if include_optional:
            return DataPagedList(
                items = [
                    libica.openapi.v3.models.data.Data(
                        id = '0', 
                        urn = '0', 
