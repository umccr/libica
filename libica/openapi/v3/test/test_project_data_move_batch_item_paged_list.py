...
class TestProjectDataMoveBatchItemPagedList(unittest.TestCase):
    """ProjectDataMoveBatchItemPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataMoveBatchItemPagedList:
        """Test ProjectDataMoveBatchItemPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataMoveBatchItemPagedList`
        """
        model = ProjectDataMoveBatchItemPagedList()
        if include_optional:
            return ProjectDataMoveBatchItemPagedList(
                items = [
                    libica.openapi.v3.models.project_data_move_batch_item.ProjectDataMoveBatchItem(
                        id = '', 
                        request = libica.openapi.v3.models.project_data_move_batch_item_request.ProjectDataMoveBatchItemRequest(
                            data_id = '', ), 
                        processing = libica.openapi.v3.models.project_data_move_batch_item_processing.ProjectDataMoveBatchItemProcessing(
                            status = '', 
    ...
    def testProjectDataMoveBatchItemPagedList(self):
        """Test ProjectDataMoveBatchItemPagedList"""
