...
class TestProjectDataLinkingBatchItemPagedList(unittest.TestCase):
    """ProjectDataLinkingBatchItemPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataLinkingBatchItemPagedList:
        """Test ProjectDataLinkingBatchItemPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataLinkingBatchItemPagedList`
        """
        model = ProjectDataLinkingBatchItemPagedList()
        if include_optional:
            return ProjectDataLinkingBatchItemPagedList(
                items = [
                    libica.openapi.v3.models.project_data_linking_batch_item.ProjectDataLinkingBatchItem(
                        id = '', 
                        request = libica.openapi.v3.models.project_data_linking_batch_item_request.ProjectDataLinkingBatchItemRequest(
                            data_id = '', ), 
                        processing = libica.openapi.v3.models.project_data_linking_batch_item_processing.ProjectDataLinkingBatchItemProcessing(
                            status = 'INITIALISED', 
    ...
    def testProjectDataLinkingBatchItemPagedList(self):
        """Test ProjectDataLinkingBatchItemPagedList"""
