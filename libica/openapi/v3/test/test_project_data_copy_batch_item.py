...
class TestProjectDataCopyBatchItem(unittest.TestCase):
    """ProjectDataCopyBatchItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataCopyBatchItem:
        """Test ProjectDataCopyBatchItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataCopyBatchItem`
        """
        model = ProjectDataCopyBatchItem()
        if include_optional:
            return ProjectDataCopyBatchItem(
                id = '',
    ...
    def testProjectDataCopyBatchItem(self):
        """Test ProjectDataCopyBatchItem"""
