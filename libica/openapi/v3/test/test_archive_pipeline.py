...
class TestArchivePipeline(unittest.TestCase):
    """ArchivePipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArchivePipeline:
        """Test ArchivePipeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArchivePipeline`
        """
        model = ArchivePipeline()
        if include_optional:
