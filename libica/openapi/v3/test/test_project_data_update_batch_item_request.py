...
class TestProjectDataUpdateBatchItemRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectDataUpdateBatchItemRequest:
        """Test ProjectDataUpdateBatchItemRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataUpdateBatchItemRequest`
        """
        model = ProjectDataUpdateBatchItemRequest()
        if include_optional:
    ...
    def testProjectDataUpdateBatchItemRequest(self):
        """Test ProjectDataUpdateBatchItemRequest"""
