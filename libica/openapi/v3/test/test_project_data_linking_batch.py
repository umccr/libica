...
class TestProjectDataLinkingBatch(unittest.TestCase):
    """ProjectDataLinkingBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataLinkingBatch:
        """Test ProjectDataLinkingBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataLinkingBatch`
        """
        model = ProjectDataLinkingBatch()
        if include_optional:
            return ProjectDataLinkingBatch(
                id = '',
    ...
    def testProjectDataLinkingBatch(self):
        """Test ProjectDataLinkingBatch"""
