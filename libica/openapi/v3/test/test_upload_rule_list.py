...
class TestUploadRuleList(unittest.TestCase):
    """UploadRuleList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadRuleList:
        """Test UploadRuleList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadRuleList`
        """
        model = UploadRuleList()
        if include_optional:
            return UploadRuleList(
                items = [
                    libica.openapi.v3.models.upload_rule.UploadRule(
                        id = '', 
