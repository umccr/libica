...
class TestCreateCwlWithJsonInputAnalysis(unittest.TestCase):
    """CreateCwlWithJsonInputAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCwlWithJsonInputAnalysis:
        """Test CreateCwlWithJsonInputAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCwlWithJsonInputAnalysis`
        """
        model = CreateCwlWithJsonInputAnalysis()
        if include_optional:
            return CreateCwlWithJsonInputAnalysis(
                ...
                analysis_input = libica.openapi.v3.models.cwl_analysis_with_json_input.CwlAnalysisWithJsonInput(
                    input_json = '', 
                    data_ids = [
                        ''
                        ], 
    ...
    def testCreateCwlWithJsonInputAnalysis(self):
        """Test CreateCwlWithJsonInputAnalysis"""
