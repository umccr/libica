...
class TestLoadDataInBaseRequest(unittest.TestCase):
    """LoadDataInBaseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoadDataInBaseRequest:
        """Test LoadDataInBaseRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoadDataInBaseRequest`
        """
        model = LoadDataInBaseRequest()
        if include_optional:
            return LoadDataInBaseRequest(
                allow_quoted_newlines = True,
                data_id = '',
                delimiter = ',',
                encoding = 'UTF8',
                force_load = True,
                header_rows_to_skip = 56,
    ...
    def testLoadDataInBaseRequest(self):
        """Test LoadDataInBaseRequest"""
