...
class TestSpeciesList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpeciesList:
        """Test SpeciesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpeciesList`
        """
        model = SpeciesList()
        if include_optional:
            return SpeciesList(
                items = [
                    libica.openapi.v3.models.species.Species(
                        id = '', 
