...
class TestAnalysisStepLogs(unittest.TestCase):
    """AnalysisStepLogs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepLogs:
        """Test AnalysisStepLogs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepLogs`
        """
        model = AnalysisStepLogs()
        if include_optional:
