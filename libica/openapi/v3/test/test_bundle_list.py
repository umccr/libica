...
class TestBundleList(unittest.TestCase):
    """BundleList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleList:
        """Test BundleList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleList`
        """
        model = BundleList()
        if include_optional:
            return BundleList(
