...
class TestNextflowAnalysisInput(unittest.TestCase):
    """NextflowAnalysisInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NextflowAnalysisInput:
        """Test NextflowAnalysisInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NextflowAnalysisInput`
        """
        model = NextflowAnalysisInput()
        if include_optional:
    ...
    def testNextflowAnalysisInput(self):
        """Test NextflowAnalysisInput"""
