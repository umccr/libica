...
class TestUploadRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UploadRule:
        """Test UploadRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadRule`
        """
        model = UploadRule()
        if include_optional:
            return UploadRule(
