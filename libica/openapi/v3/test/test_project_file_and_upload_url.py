...
class TestProjectFileAndUploadUrl(unittest.TestCase):
    """ProjectFileAndUploadUrl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectFileAndUploadUrl:
        """Test ProjectFileAndUploadUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectFileAndUploadUrl`
        """
        model = ProjectFileAndUploadUrl()
        if include_optional:
            return ProjectFileAndUploadUrl(
    ...
    def testProjectFileAndUploadUrl(self):
        """Test ProjectFileAndUploadUrl"""
