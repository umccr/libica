...
class TestBundleDataUnlinkingBatch(unittest.TestCase):
    """BundleDataUnlinkingBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleDataUnlinkingBatch:
        """Test BundleDataUnlinkingBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleDataUnlinkingBatch`
        """
        model = BundleDataUnlinkingBatch()
        if include_optional:
            return BundleDataUnlinkingBatch(
                id = '',
    ...
    def testBundleDataUnlinkingBatch(self):
        """Test BundleDataUnlinkingBatch"""
