...
class TestProjectDataLinkingBatchItem(unittest.TestCase):
    """ProjectDataLinkingBatchItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataLinkingBatchItem:
        """Test ProjectDataLinkingBatchItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataLinkingBatchItem`
        """
        model = ProjectDataLinkingBatchItem()
        if include_optional:
            return ProjectDataLinkingBatchItem(
                id = '',
    ...
    def testProjectDataLinkingBatchItem(self):
        """Test ProjectDataLinkingBatchItem"""
