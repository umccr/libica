...
class TestPipelineFileList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PipelineFileList:
        """Test PipelineFileList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PipelineFileList`
        """
        model = PipelineFileList()
        if include_optional:
            return PipelineFileList(
                items = [
                    libica.openapi.v3.models.pipeline_file.PipelineFile(
                        id = '', 
                        name = '0', )
                    ]
            )
