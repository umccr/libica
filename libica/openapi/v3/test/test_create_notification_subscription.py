...
class TestCreateNotificationSubscription(unittest.TestCase):
    """CreateNotificationSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNotificationSubscription:
        """Test CreateNotificationSubscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNotificationSubscription`
        """
        model = CreateNotificationSubscription()
        if include_optional:
    ...
    def testCreateNotificationSubscription(self):
        """Test CreateNotificationSubscription"""
