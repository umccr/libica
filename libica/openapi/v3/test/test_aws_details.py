...
class TestAWSDetails(unittest.TestCase):
    """AWSDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AWSDetails:
        """Test AWSDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AWSDetails`
        """
        model = AWSDetails()
        if include_optional:
            return AWSDetails(
