...
class TestCreateNotificationChannel(unittest.TestCase):
    """CreateNotificationChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNotificationChannel:
        """Test CreateNotificationChannel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNotificationChannel`
        """
    ...
    def testCreateNotificationChannel(self):
        """Test CreateNotificationChannel"""
