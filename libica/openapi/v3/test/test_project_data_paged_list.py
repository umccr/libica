...
class TestProjectDataPagedList(unittest.TestCase):
    """ProjectDataPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataPagedList:
        """Test ProjectDataPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataPagedList`
        """
        model = ProjectDataPagedList()
        if include_optional:
            return ProjectDataPagedList(
                items = [
                    libica.openapi.v3.models.project_data.ProjectData(
    ...
    def testProjectDataPagedList(self):
        """Test ProjectDataPagedList"""
