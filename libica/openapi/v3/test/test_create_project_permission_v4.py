...
class TestCreateProjectPermissionV4(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateProjectPermissionV4:
        """Test CreateProjectPermissionV4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateProjectPermissionV4`
        """
        model = CreateProjectPermissionV4()
        if include_optional:
            return CreateProjectPermissionV4(
                role_project = 'NONE',
    ...
    def testCreateProjectPermissionV4(self):
        """Test CreateProjectPermissionV4"""
