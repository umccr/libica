...
class TestJobPagedList(unittest.TestCase):
    """JobPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPagedList:
        """Test JobPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPagedList`
        """
        model = JobPagedList()
        if include_optional:
            return JobPagedList(
                items = [
                    libica.openapi.v3.models.job.Job(
                        id = '', 
                        status = 'INITIALIZED', 
