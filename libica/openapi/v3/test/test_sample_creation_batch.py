...
class TestSampleCreationBatch(unittest.TestCase):
    """SampleCreationBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleCreationBatch:
        """Test SampleCreationBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleCreationBatch`
        """
        model = SampleCreationBatch()
        if include_optional:
            return SampleCreationBatch(
                id = '',
    ...
    def testSampleCreationBatch(self):
        """Test SampleCreationBatch"""
