...
class TestCreateNextflowAnalysis(unittest.TestCase):
    """CreateNextflowAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNextflowAnalysis:
        """Test CreateNextflowAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNextflowAnalysis`
        """
        model = CreateNextflowAnalysis()
        if include_optional:
    ...
    def testCreateNextflowAnalysis(self):
        """Test CreateNextflowAnalysis"""
