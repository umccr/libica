...
class TestDataDetails(unittest.TestCase):
    """DataDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataDetails:
        """Test DataDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataDetails`
        """
        model = DataDetails()
        if include_optional:
            return DataDetails(
