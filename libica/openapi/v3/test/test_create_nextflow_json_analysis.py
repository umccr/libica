...
class TestCreateNextflowJsonAnalysis(unittest.TestCase):
    """CreateNextflowJsonAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNextflowJsonAnalysis:
        """Test CreateNextflowJsonAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNextflowJsonAnalysis`
        """
        model = CreateNextflowJsonAnalysis()
        if include_optional:
            return CreateNextflowJsonAnalysis(
    ...
    def testCreateNextflowJsonAnalysis(self):
        """Test CreateNextflowJsonAnalysis"""
