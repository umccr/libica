...
class TestProjectDataMoveBatchItem(unittest.TestCase):
    """ProjectDataMoveBatchItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataMoveBatchItem:
        """Test ProjectDataMoveBatchItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataMoveBatchItem`
        """
        model = ProjectDataMoveBatchItem()
        if include_optional:
            return ProjectDataMoveBatchItem(
                id = '',
    ...
    def testProjectDataMoveBatchItem(self):
        """Test ProjectDataMoveBatchItem"""
