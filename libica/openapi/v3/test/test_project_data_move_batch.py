...
class TestProjectDataMoveBatch(unittest.TestCase):
    """ProjectDataMoveBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDataMoveBatch:
        """Test ProjectDataMoveBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDataMoveBatch`
        """
        model = ProjectDataMoveBatch()
        if include_optional:
            return ProjectDataMoveBatch(
                id = '',
    ...
    def testProjectDataMoveBatch(self):
        """Test ProjectDataMoveBatch"""
