...
class TestAnalysisLogs(unittest.TestCase):
    """AnalysisLogs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisLogs:
        """Test AnalysisLogs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisLogs`
        """
        model = AnalysisLogs()
        if include_optional:
            return AnalysisLogs(
                logs_folder = libica.openapi.v3.models.data.Data(
                    id = '0', 
                    urn = '0', 
