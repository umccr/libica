...
class TestStorageConfiguration(unittest.TestCase):
    """StorageConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StorageConfiguration:
        """Test StorageConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StorageConfiguration`
        """
    ...
    def testStorageConfiguration(self):
        """Test StorageConfiguration"""
