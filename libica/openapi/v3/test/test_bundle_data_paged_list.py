...
class TestBundleDataPagedList(unittest.TestCase):
    """BundleDataPagedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleDataPagedList:
        """Test BundleDataPagedList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleDataPagedList`
        """
        model = BundleDataPagedList()
        if include_optional:
            return BundleDataPagedList(
                items = [
                    libica.openapi.v3.models.bundle_data.BundleData(
    ...
    def testBundleDataPagedList(self):
        """Test BundleDataPagedList"""
