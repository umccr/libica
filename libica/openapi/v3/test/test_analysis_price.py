...
class TestAnalysisPrice(unittest.TestCase):
    """AnalysisPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisPrice:
        """Test AnalysisPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisPrice`
        """
        model = AnalysisPrice()
        if include_optional:
