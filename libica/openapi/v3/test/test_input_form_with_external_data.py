...
class TestInputFormWithExternalData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InputFormWithExternalData:
        """Test InputFormWithExternalData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFormWithExternalData`
        """
        model = InputFormWithExternalData()
        if include_optional:
            return InputFormWithExternalData(
                data_id = '',
