...
class CreateCwlAnalysis(BaseModel):
    ...
    activation_code_detail_id: Optional[UUID] = Field(default=None, description="Indicates under which activation code the pipeline is executed.", alias="activationCodeDetailId")
    __properties: ClassVar[List[str]] = ["userReference", "pipelineId", "tags", "analysisStorageId", "outputParentFolderId", "logs", "analysisOutput", "analysisInput", "activationCodeDetailId"]
