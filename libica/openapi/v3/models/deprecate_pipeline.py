...
class DeprecatePipeline(BaseModel):
    """
    DeprecatePipeline
    """ # noqa: E501
    message: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="An optional message from the pipeline developer")
