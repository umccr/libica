...
class InputFormFieldValues(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    values: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Use 'values' for all fields except data fields. Use string values to avoid rounding of numbers with a high precision.")
