...
class GitCredential(BaseModel):
    ...
    git_url: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="gitUrl")
    __properties: ClassVar[List[str]] = ["id", "timeCreated", "timeModified", "ownerId", "tenantId", "tenantName", "name", "gitUrl"]
