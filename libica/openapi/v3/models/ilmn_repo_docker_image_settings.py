...
class IlmnRepoDockerImageSettings(BaseModel):
    """
    IlmnRepoDockerImageSettings
    """ # noqa: E501
    global_url: StrictStr = Field(alias="globalUrl")
    regions: Optional[List[Optional[IlmnRepoDockerImageRegion]]] = None
    __properties: ClassVar[List[str]] = ["globalUrl", "regions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "globalUrl": obj.get("globalUrl"),
            "regions": [IlmnRepoDockerImageRegion.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
